...
-- Tiempo de generación: 11-12-2023 a las 20:06:33
...
CREATE DEFINER=`minervatech`@`localhost` PROCEDURE `insert_log` (IN `p_date` VARCHAR(20), IN `p_time` VARCHAR(8), IN `p_procedure` VARCHAR(255), IN `presupuesto_id` INT(100), IN `p_in` VARCHAR(1000), IN `p_out` VARCHAR(1000))   BEGIN
    INSERT INTO logs (`date`, `time`, `procedure`,`presupuesto_id`, `in`, `out`)
    VALUES (p_date, p_time, p_procedure, presupuesto_id, p_in, p_out);
END$$
...
INSERT INTO `logs` (`date`, `time`, `procedure`, `presupuesto_id`, `in`, `out`) VALUES
('2023-12-11', '20:04:14', 'https:!!minervatech.uy!simulador2!', 501, 'area', '1326'),
('2023-12-11', '20:04:34', 'https:!!minervatech.uy!simulador2!', 501, 'latitud', '-34.9465946'),
('2023-12-11', '20:04:51', 'https:!!minervatech.uy!simulador2!', 501, 'longitud', '-54.93192149999999'),
('2023-12-11', '20:05:25', 'https:!!minervatech.uy!simulador2!', 501, 'direccion', 'Cordón, Montevideo Departamento de Montevideo, Uruguay');
...
('m.gonzalez.uy1991@gmail.com', 'gAAAAABld1lBqT6YC3ycHB3a1FQLQ1x_8hHI-tUjzVbir_06cXOVK3XP-bRP0pUqamaP8uBKzcGThd-NaRBa3GDGVhPlTKaJbQ==', NULL, 'Maximiliano', '2023-12-11', '0.0.0.0', '', 1, ''),
