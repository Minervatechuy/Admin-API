    ...
    if (count($result_stage_info) > 0){
        ...
        <div class="card card-row card-secondary">
            <div class="card-header">
                <h3 class="card-title">
                    Editar Opciones ('.count($result_stage_info).' total)
                </h3>
            </div>
            <div class="card-body">
                <div class="container">
        ...
        foreach ($result_stage_info as $opcion_x) { 
            echo            '<div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h5 class="card-title">'.$opcion_x[0][3].'</h5>
                                    <form action="editarOpcion.php" method="POST">
                                        <div class="card-tools" style="">
                                            ...
                                            <input type="hidden" value="'.$opcion_x[0][0].'" name="opcion_id"/>
